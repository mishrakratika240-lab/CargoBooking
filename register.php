...
<body class="text-muted">
	...
	<!-- register  -->
	<div class="blockk text-muted" >
	<div class="modal-body align-w3" style="padding: 1em !important; ">
		<div class="container">
				<div class="row col-md-12 col-md-offset-">
					<!-- <div class="panel panel-body"> -->
						<div class="center">
									<form action="connection.php" method="post" class="p-sm-3 panel panel-body" class="color">
										 			<?php
										...
										<div class="form-group  color">
											<b><label for="recipient-name" style="color:black;" class="col-form-label">Username</label>
											<input type="text" class="form-control" placeholder="your name" name="name" id="recipient-name" >
										</div>
										<div class="form-group">
											<label for="mobile" class="col-form-label" style="color:black;">mobile</label>
											<input type="number" class="form-control" placeholder="******" name="mobile" id="" >
										</div>

										<div class="form-group">
											<label for="recipient-email" class="col-form-label" style="color:black;">Email</label>
											<input type="email" class="form-control" placeholder="loremipsum@email.com" name="email" id="recipient-email"
											 >
										</div>
										<div class="form-group">
											<label for="password1" class="col-form-label" style="color:black;">Password</label>
											<input type="password" class="form-control" placeholder="******" name="password" id="password1" >
										</div>
										<div class="form-group">
											<label for="password2" class="col-form-label" style="color:black;">Confirm Password</label>
											<input type="confirm_password" class="form-control" placeholder="******" name="confirm_password" id="password2" >
										</div>
										<div class="sub-w3l">
