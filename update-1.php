...
<body>
					...
					<nav>
						...
						<ul class="menu">
							...
							<li class="ml-xl-5 ml-lg-2 mt-lg-0 mt-sm-4 mt-3">
								<a href="login.php" class="reqe-button"style="background:green;padding: 9px;letter-spacing:0px"> Admin Login</a>
	...
	<!-- //breadcrumbs -->
				<div class="container "  style="margin-left:300px ; padding-right: 550px;">
	...
	<div class="modal-body align-w3" style="padding: 1em !important; ">
		<form action="update-conn-1.php?id=<?php echo $value['id']?>;" method="post" class="p-sm-3">

		<!-- 					<a class="btn btn-success" href="register.php">Add User</a>
				<a class="btn btn-success" href="dashboard.php">User List</a>
 -->
			<div class="form-group">
				<label for="recipient-name" style="color:white;" class="col-form-label">Username</label>
				<input type="text" class="form-control" placeholder="your name" name="name" id="recipient-name" value="<?php echo $value['name'];?>" >
			</div>
			<div class="form-group">
				<label for="mobile" class="col-form-label" style="color:white;">mobile</label>
				<input type="number" class="form-control" placeholder="******" name="mobile" id="" value="<?php echo $value['mobile'];?>" >
			</div>

			<div class="form-group">
				<label for="recipient-email" class="col-form-label" style="color:white;">Email</label>
				<input type="email" class="form-control" placeholder="loremipsum@email.com" name="email" id="recipient-email"  value="<?php echo $value['email'];?>" 
				 >
			</div>
			<div class="form-group">
				<label for="password1" class="col-form-label" style="color:white;">Password</label>
				<input type="password" class="form-control" placeholder="******" name="password" id="password1"value="<?php echo $value['password'];?>"  >
			</div>
			<div class="form-group">
				<label for="password2" class="col-form-label" style="color:white;">Confirm Password</label>
				<input type="password" class="form-control" placeholder="******" name="confirm_password" id="password2" >
			</div>
			<div class="sub-w3l">
				<div class="sub-w3layouts_hub">
					<input type="checkbox" name="is_agree_terms_conditions" id="brand2" value="yes">
					<label for="brand2" class="mb-3 text-secondary" >
						<span></span>I Accept to the Terms & Conditions</label>
				</div>
			</div>
			<div class="right-w3l">
				<input type="submit" name="submit" class="form-control bg-theme" value="Update" name="update">
			</div>
		</form>
	</div>
	<!-- //register -->
	...
	<footer class="footer py-md-5 pt-md-3 pb-sm-5" style="margin-top:4% !important">
		<div class="container">
