...
<head>
    ...
    <style >
        ...
        .box{
            border-style:#ffffff63;
/*            width: 500px;*/
/*            margin-left: 40px;*/
            background:#ffffff08;
            box-shadow: 0 25px 25px rgba(1,4,1,1.3);
        }
        .Trans{
            background: #ffffff63;
...
<div class="back">
        <!-- blog post-->
        <section class="post-wthree align-w3" id="blog" style="margin-top:-18px">           
         <div class="container">
        ...
        <div class="color ">
            <div class="center_div">
                <form action="connection.php" method="post" class="">
                    <?php
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input class="form-control" type="text" name="full_name" value="full_name" placeholder="Full Name" required ></input>  
                    </div>
                    <div class="form-group col-md-12">
                        <label for="email" >Email</label>
                        <input class="form-control" type="email" name="email" value="email" placeholder="email" required ></input>  
                    </div>
                            <div class="form-group col-md-12">
                            <!-- print_r('string');die(); -->
                                <label for="phone_number" >Phone Number</label>
                                <input type="text"class="form-control" name="phone_number" value="phone_number" placeholder="Phone number" required ></input><br>
                                <div class=form-group>
                                     <label  for="adhar_number">Adhar number</label>
                                    <input type="text" class="form-control" name="adhar_number"  value="adhar_number" placeholder="Adhar number" required ></input>
                                </div>
                                ...
                                <h3 style="text-align: center; margin: 12px;text-decoration: underline;background: lightyellow;"> BOOKING DETAILS</h3>
                                     <br>
                                    <div class="form-group">
                                        <label for="mm/dd/yyyy" > Date </label>

                                        <input  type="date" name="booking_date"class="form-control" value="booking_date" placeholder="mm/dd/yyyy"  required style="width: 99%;
                                        /*margin-right: 40% ;*/ margin-left:1px !important;" ></input>
                                    </div>
                                        <div class="form-group">
                                             <label for="Pickup_time" >Pickup_time  </label>
                                            <input type="time" class="form-control" name="booking_time" value="booking_time" placeholder="Pickup time" required style="width:99%;
                                             margin-right: 2px;margin-left: 3px ;" ></input>
                                        </div>                                        
                                    <div class="form-group">
                                        <label for="pickup_location" > Pickup_location </label>
                                        <input type="text" class="form-control" name="pickup_location" value="pickup_location"  placeholder="Pickup_location"  required ></input>
                                    </div>
                                    <div class="form-group">
                                         <label >drop_off_location  </label>
                                        <input type="text" name="drop_off_location" value="drop_off_location" placeholder="Drop_off_location" class="form-control" required ></input>
                                    </div>
                                        <!-- <div style="margin-left: 12px;margin-right: 21px;width: 100% !important;"> -->
                                    <div class="form-group">   
                                        <label  for="material_weight">material_weight</label>
                                        <input type="text" class="form-control" name="material_weight" placeholder=" material weight" style="width:100%;padding:px;">
                                    </div>
                                    <div class="form-group">
                                        <label  for="material_unit">material_unit</label>
                                        <input type="text"  class="form-control" name="material_unit" value="material_unit" placeholder=" material unit" style="width:100%;padding: px;">
                                    </div>
                                    <div class="form-group">
                                        <label for="cargo_type"> Cargo type</label>
                                        <select  class="form-control" for="type"  name="cargo_type"  value="cargo_type"   placeholder=" cargo_type" style="width:100%;padding: 2px;" >
                                        ...
                                        <input type="submit" name="submit"onclick="openPopup()" value="submit" style="margin-left:25%;padding-right: 4px;background: deepskyblue;padding:10px;margin-bottom:22px">   
                                        <input type="reset" name="reset" value="reset"style="margin-left:25%;margin-right:4%;padding-right: 4px; background: skyblue;padding:10px;margin-bottom:22px" >
            ...
            <div class="row p-sm-4 px-3 py-3">
                <div class="col-lg-4 footer-top mt-md-0 mt-sm-5">
                    ...
                    <div class="fv3-contact">
                        <p>
                            "Every cargo shipment tells a story of connection and commerce,  bridging worlds through every mile."
                            <br>
                        </p>
                    </div>
                </div>
