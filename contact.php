        ...
        <div class="container">
            ...
            ?>
                    ...
                    <div class="contact-form-wthreelayouts">
                        <form action="contactconnection.php" method="post" class="register-wthree">
                            <div class="form-group">
                                <label>
                                    Your Name
                                </label>
                                <input class="form-control" type="text" placeholder="name" name="your_name">
                            </div>
                            <div class="form-group">
                                <label>
                                    Mobile
                                </label>
                                <input class="form-control" type="number" placeholder="xxxx xxxxx" name="mobile">
                            </div>
                            <div class="form-group">
                                <label>
                                    Email
                            ...
                            <div class="form-group mb-0">
                                <button type="submit"  name="submit"  class="btn btn-w3layouts btn-block bg-theme text-wh w-100 font-weight-bold text-uppercase">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
